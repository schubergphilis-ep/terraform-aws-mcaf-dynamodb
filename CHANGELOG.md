...
* feat: harden table config, add GSI insights, and improve validations (#9) @tmoreau-sbp

**Full Changelog**: https://github.com/schubergphilis/terraform-aws-mcaf-dynamodb/compare/v0.3.0...v0.4.0
