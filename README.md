...
| <a name="input_table_warm_throughput"></a> [table\_warm\_throughput](#input\_table\_warm\_throughput) | Sets the warm throughput for the table. Minimum values are read_units_per_second: 12000, write_units_per_second: 4000. | <pre>object({<br>    read_units_per_second  = optional(number, null)<br>    write_units_per_second = optional(number, null)<br>  })</pre> | `null` | no |
